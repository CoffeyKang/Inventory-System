...
@section('content')
	<fieldset>
		<legend>Enter Container.</legend>
		 <form class="form-horizontal" role="form" method="GET" action="{{ url('/PO/newContainer2') }}" >
						
                        <div class="form-group">
                            <label for="reqno" class="col-xs-4 control-label" style='text-align:right'> Container Number</label>
                            <div class="col-xs-6">
                                <input id="reqno" style='background-color:lightblue' type="text" class="form-control" name="reqno" value="{{ old('reqno') }}" autofocus>

                            @if ($errors->has('reqno'))
                                    <span class="help-block">
                                        <strong>{{ $errors->first('reqno') }}</strong>
                                    </span>
                            @endif    
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-6">
                                <input id="vendno" type="text" class="form-control" name="vendno" value="{{ old('vendno') }}">
