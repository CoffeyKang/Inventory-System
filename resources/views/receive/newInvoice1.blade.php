...
@section('content')
	<fieldset>
		<legend>Enter Customer Number and Invoice Type.</legend>
		 <form class="form-horizontal" role="form" method="GET" action="{{ url('/Receive/newInvoice2') }}" >
						<div class="col-xs-12"  style='text-align:center'>
							<h3><b>Enter Customer Number or Telephone Number.</b></h3>
						</div>
						
                       {{--  <div class="form-group{{ $errors->has('type') ? ' has-error' : '' }}">
                            <label for="type" class="col-xs-4 control-label">Invoice Type</label>
                        ...
                        <div class="form-group{{ $errors->has('enterNumber') ? ' has-error' : '' }}">
                            <label for="enterNumber" class="col-xs-4 control-label">Enter Numbers</label>

                            <div class="col-xs-6 " >
                                <select name="enterNumber" id="enterNumber" class='form-control'>
                                    <option value="N">NO</option>
                                    <option value="Y">YES</option>
                                </select>

                                @if ($errors->has('enterNumber'))
                                    <span class="help-block">
                                        <strong>{{ $errors->first('enterNumber') }}</strong>
                                    </span>
                                @endif
                            </div>
