...
<form action="/Receive/creditMemo2" method='post'>
<div class="col-xs-12">
	<fieldset>
...
<div class="col-xs-12">
    <fieldset>
        <legend> Credit Memos</legend>

        @if(isset($invno))
            <input type="hidden" name='invno' value='{{$invno}}'>
        @endif
        <div class="col-xs-8 col-xs-offset-2 form-group">
                <label for="item" class='control-label col-xs-3'>Credit Memos</label>
                <div class="col-xs-9 input-group">
                    <input type='text' class='form-control' name='item' id='item' value='Credit Memos' readonly>
                </div>     
        </div>

        <div class="col-xs-8 col-xs-offset-2 form-group">
                <label for="invdte" class='control-label col-xs-3'>MC Date</label>
                <div class="col-xs-9 input-group">
        ...
        <div class="col-xs-8 col-xs-offset-2 form-group">
                <label for="invamt" class='control-label col-xs-3'>MC Price</label>
                <div class="col-xs-9 input-group">
        ...
        @if(!isset($shortlist))
        <div class="col-xs-8 col-xs-offset-2 form-group">
                <label for="tax" class='control-label col-xs-3'>MC Tax</label>
                <div class="col-xs-9 input-group">
        ...
        <div class="col-xs-8 col-xs-offset-2 form-group" >
                <label for="descrip" class='control-label col-xs-3'>MC Note</label>
                <div class="col-xs-9 input-group">
    ...
    <tbody>
      ...
      <tr>
        ...
        <th><a href='voidCreditMemos?invno={{$invno}}' class="btn btn-danger" style='min-width:170px'>Void Memos</a></th>
        <th><a href="finishMemos?invno={{$invno}}&custno={{$customer->custno}}" style='min-width:170px' class="btn btn-primary">Finish Memos</a></th>
      </tr>
    </tbody>
  </table>
    </fieldset>
