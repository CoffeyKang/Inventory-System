...
<form action="/Receive/toShortList" method="post">
    <div class="col-xs-12">
        {{-- part 1 --}}
        <fieldset>
            <legend>Credit Memo Entry for Customer {{session()->get('header.custno')}}, {{session()->get('header.company')}}.</legend>
            <div class="col-xs-12">
                ...
                <table class="table table-striped col-xs-12" >
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <th colspan='4'></th>
                            <th><a href="/Receive/editOrder_memo?custno={{session()->get('header.custno')}}&invno={{$invno}}" class='btn btn-primary' style=''>Edit Order</a></th>
                            <th>
                                <form action="/Receive/finishMemo" method='post'>
                                    <input type="hidden" name='invno' value='{{$invno}}'>
                                    <input type="hidden" name='subtotal' value='{{$subtotal}}'>
                                    <input type="hidden" name='total' value='{{$total}}'>
                                    <button class="btn btn-primary" style=''>Finsh Memo</button>
                                </form>
                            </th>
                        </tr>
                    </tbody>
