	...
	<fieldset style='text-align:left; color:black; font-weight:900'>
  	...
  	@if(isset($_GET['lastpage']))
		...
		<div class="col-xs-12" style='font-size:16px;text-align:center'><hr>
			<div class="col-xs-3">{{-- <a href="#123" data-toggle="modal" data-target="#myModal"><b>Delete</b></a> --}}<a href="/Payable/vendorNote?vendno={{$vendor->vendno}}&from=Payable"><b>Note</b></a></div>
			<div class="col-xs-3"><a href="/Payable/VendorEdit?vendno={{$vendor->vendno}}"><b>Edit</b></a></div>
			<div class="col-xs-3"><a href="{{url('/Payable/createVendor1')}}"><b>Create</b></a></div>
		...
		<div class="col-xs-12">
	        ...
	        <div class="form-group{{ $errors->has('type') ? ' has-error' : '' }}">
	            ...
	            <div class="col-xs-3 ">
	               <input type="date"  name='from_date' value="{{date('Y-m-d', strtotime('-1 month'))}}">
	            </div>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content ">
        ...
        <div class="modal-footer">
          ...
          {{-- <a href='{{url("/admin/deleteVendor?vendno=$vendor->vendno&from=payable")}}' class="btn btn-success" id='doubleCheck'>Delete Vendor</a> --}}
