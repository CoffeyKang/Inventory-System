...
<fieldset>
	...
	<form class="form-horizontal" role="form" method="POST" id='newVendor' action="{{ url('/PO/createVendor3') }}" >
		...
		<div class="form-group" >
			<div class="col-xs-12" style='text-align:right'>
				...
				{{-- <button type="submit" style='min-width:230px' id='registerBTN' class="btn btn-primary">
				Add new Vendor
				</button> --}}
