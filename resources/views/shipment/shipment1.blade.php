...
<form class="form-horizontal" role="form" method="get" action="/Shipment/shipment2">
	<fieldset>
	<div class="col-xs-12">
			...
			<div class="col-xs-6">
				...
				@if ($errors->has('sono'))
                    <span class="help-block" >
                        <strong style='color:red'>{{ $errors->first('sono') }}</strong>
                    </span>
                @endif
			</div>
...
<form class="form-horizontal" role="form" method="get" action="/Shipment/searchByCustno">		
