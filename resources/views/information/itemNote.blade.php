...
@section('content')
<fieldset>
    <legend>Item {{$item->item}} Notes</legend>
	...
	@if(isset($notes))
		@foreach($notes as $note)
			<div class="container-fuild alert alert-info">
				...
				<a class='btn btn-danger delteNote' onclick='doublecheck()' href='/deleteItemNote?id={{$note->id}}'>Delete</a>
				</div>
			</div>
		@endforeach
