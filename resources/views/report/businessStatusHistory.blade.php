...
@section('content')
	...
	<fieldset>
		<legend>Business Status report {{$from}} ==> {{$end}} </legend>
			...
			<tr>
				<td>
					<div class="col-xs-6">
						...
						<div class="col-xs-12 text-left">INVENTORY VALUE:</div>
					</div>
					<div class="col-xs-6">
		...
		<div class="col-xs-12" style='text-align:right'>
			...
			<a href="PDF/business_status_history/{{date('Y-m-d')}}.PDF" class="btn btn-success" style='min-width:100px' download>Download</a>
			<a href="/web/viewer.html?file=/PDF/business_status_history/{{date('Y-m-d')}}.PDF" class="btn btn-success" style='min-width:100px' target="_blank">Print</a>
		</div>
