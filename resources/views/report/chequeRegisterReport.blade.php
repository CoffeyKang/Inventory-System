...
@section('content')
	...
	<fieldset>
		...
		<div class="col-xs-12">
			<form action="/ShowChequeRegisterReport" class="form-inline">
		...
		@if(isset($payment))
			...
			<table class="table table-striped table-bordered" style='font-size:14px;'>
			  ...
			  <hr><div class="col-xs-12 text-right" >
			  <a href="PDF/chequeRegisterReport/chequeRegisterReport{{date('Y-m-d')}}.PDF" class="btn btn-success" style='min-width:100px' download>Download</a>
			<a href="/web/viewer.html?file=/PDF/chequeRegisterReport/chequeRegisterReport{{date('Y-m-d')}}.PDF" class="btn btn-success" style='min-width:100px' target="_blank">Print</a>
			</div>
