...
@endif
  ...
  <form action="/itemUpdate" class='form-horizontal' role="form" method='post'>
    ...
    <div class="col-xs-12  form-group">
        ...
        <div class="col-xs-2">
          ...
          <select name="itemcontinue" id="itemcontinue" class='form-control'>
      ...
      <div class="col-xs-12  form-group">
        ...
        <label for="vpartno" class="col-xs-2">P/N</label>
        <div class="col-xs-2">
  ...
  <legend>Supplier Information</legend>
      ...
      <div class="col-xs-12 form-group">
        ...
        <div class="col-xs-4">
          <a href="/addSupplier?item={{$item->item}}" class="btn btn-success">Add Supplier</a>
        </div>
