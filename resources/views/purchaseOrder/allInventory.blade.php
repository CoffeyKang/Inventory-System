...
@section('content')
	...
	<div class="col-xs-12" style='text-align:right'><a href="{{url('/PO/inventory')}}" class="btn btn-primary">Back To Search</a></div>
	<table class="table table-striped" id='searchResultTable'>
	    ...
	    <tbody>
			...
			<tr>
				...
				<td class=""><a href='/PO/itemInfo?item={{$Item->item}}'>{{$Item->descrip}}</a></td>
				<td class=""><a href='/PO/itemInfo?item={{$Item->item}}'>{{$Item->item}}</a></td>
