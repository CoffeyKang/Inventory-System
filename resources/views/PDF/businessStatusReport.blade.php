...
<body>
		...
		<h3>Business Status report @if(isset($rate)) forecast @endif</h3>
			<h5> {{date('Y-m-d')}} </h5>
		...
		<table style='width:60%;'>
			...
			<tr>
				...
				<td class='right'>$ {{number_format($receivable['inventory_value_cad'],2)}}</td>
			</tr>
		...
		<div>
			<h5><b>NUMBER OF WORKING DAYS : {{$days}} </b></h5>
			<h5><b>TOTAL NUMBER OF WORKING DAYS : {{$total_days}}</b></h5>
		</div>
